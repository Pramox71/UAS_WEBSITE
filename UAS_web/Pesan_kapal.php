        ...
        <div class="posisi">
          ...
          <div class="card">
            ...
            <div class="content-text">
              ...
              <br>
              <div class="btn-block">
                <a href="Transaksi.php?id=<?php echo $data['ID_Kapal'];?>&harga=<?php echo $data['Harga'];?> onclick = "return confirm('Apakah Anda Yakin memesan Hotel <?php echo $data['nama']; ?>?')" class="btn-order">Pesan</a>
              </div>
            </div>
          </div>
          <?php endforeach;?>
