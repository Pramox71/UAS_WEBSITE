<?php session_start(); 
    ...
    require "Koneksi.php";
    $result = mysqli_query($db, "SELECT ID_Kapal, Nama_Kapal AS nama, Pelabuhan AS daerah, Tujuan, Harga, Foto_kapal FROM kapal");
    $kapal = [];
        ...
        <div class="posisi">
          ...
          <div class="card">
            ...
            <div class="content-text">
              ...
              <br>
              <div class="btn-block">
                <a href="Edit.php?id=<?php echo $data['ID_Kapal'];?>" class="btn-order">Edit</a>
              </div>
              <div class="btn-block">
                <a href="hapus.php?id=<?php echo $data['ID_Kapal'];?>" onclick = "return confirm('Apakah Anda Yakin Ingin Menghapus ?')" class="btn-order">Hapus</a>
              </div>
            </div>
          </div>
          <?php endforeach;?>
          <div class="card">
              <div class="btn-block">
                <a href="Tambah_kapal.php" class="btn-order">Tambah Data</a>
              </div>
          </div>
        </div>
      </div>
